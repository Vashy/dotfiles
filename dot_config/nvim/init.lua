...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- vim.keymap.set('n', '<leader>fF', builtin.resume, { desc = '[F]ind Resume' })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { c = true, cpp = true, java = true, xml = true }
...
require('localplugins.todofloat').setup {
  target_file = vim.fn.stdpath 'data' .. '/todo.md',
}
